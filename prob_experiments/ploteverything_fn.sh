...
echo       "'fn4' using 2:(\$1==$P?\$3*\$2:1/0) with lines ls 23 notitle, \\">>gp
echo       "'fn5' using 2:(\$1==$P?\$3*\$2:1/0) with lines ls 28 notitle, \\">>gp
echo       "'fn5' using 2:(\$1==$P?\$3*\$2:1/0):4 with yerrorbars ls 8 title 'c8', \\">>gp
echo       "'fn4' using 2:(\$1==$P?\$3*\$2:1/0):4 with yerrorbars ls 5 title 'c4', \\">>gp
echo       "'fn3' using 2:(\$1==$P?\$3*\$2:1/0):4 with yerrorbars ls 3 title 'c3', \\">>gp
echo       "'fn2' using 2:(\$1==$P?\$3*\$2:1/0):4 with yerrorbars ls 9 title 'c2', \\">>gp
echo       "'fn1' using 2:(\$1==$P?\$3*\$2:1/0):4 with yerrorbars ls 25 title 'Hilbert c1' ">>gp
