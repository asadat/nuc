echo "set terminal pdf size 20cm, 7cm" > gp
...
echo       "'fp5' using 2:(\$1==$P?\$3*100:1/0) with lines ls 16 notitle, \\">>gp
echo       "'fp5' using 2:(\$1==$P?\$3*100:1/0):4 with yerrorbars ls 16 title 'C(0.2,0.3,0.2,0.3)', \\">>gp
